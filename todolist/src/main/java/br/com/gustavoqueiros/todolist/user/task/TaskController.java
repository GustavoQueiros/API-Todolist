package br.com.gustavoqueiros.todolist.user.task;
...
import br.com.gustavoqueiros.todolist.utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity creat(@RequestBody TaskModel taskModel, HttpServletRequest request) {
        ...
        if (taskModel.getStartAt().isAfter(taskModel.getEndAt())) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body("A data de de início deve ser menor que a data de término");
        }
